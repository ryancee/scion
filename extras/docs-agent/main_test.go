...
func withMockCommand(t *testing.T, fn func(ctx context.Context, name string, args []string, env []string) (string, error)) {
	t.Helper()
	orig := runCommand
	runCommand = fn
...
func TestHandleAskSuccess(t *testing.T) {
	withMockCommand(t, func(ctx context.Context, name string, args []string, env []string) (string, error) {
		if name != "gemini" {
...
func TestStripANSI(t *testing.T) {
	...
	result := ansiRegexp.ReplaceAllString(input, "")
